    ...
    <div class="content-wrapper">
        <section class="content-header d-print-none">
            <div class="container">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Laporan Barang Masuk (Pembelian)</h1>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="card-body p-3">
                        <div class="row align-items-center">
                            <div class="col-md-8 col-sm-12 mb-2 mb-md-0">
                                <form action="{{ route('dashboard.reports.incoming') }}" method="GET" class="form-inline">
                            ...
                            <div class="col-md-4 col-sm-12 text-md-right text-left">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('dashboard.reports.exportIncoming', ['start_date' => $startDate, 'end_date' => $endDate]) }}">
                                            <i class="fas fa-file-excel text-success mr-2"></i> Download Excel
                                        </a>
                                        
                                        <a class="dropdown-item" href="{{ route('dashboard.reports.exportIncomingPdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}">
                            ...
                            <table class="table table-bordered table-striped">
                                <thead class="bg-primary text-white">
                                    <tr>
                                        ...
                                        <th style="width: 45%">Rincian Produk (Qty & Batch)</th>
                                        <th style="width: 25%">Catatan / Supplier</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <ul class="mb-0 pl-3">
                                                @foreach($trx->details as $detail)
                                                    <li>
                                                        ...
                                                        +{{ $detail->quantity }} Pcs 
                                                        <small class="text-muted">(Batch: {{ $detail->batch->batch_number ?? '-' }})</small>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </td>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="4" class="text-center">Tidak ada transaksi barang masuk pada periode ini.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
